...
$sort_name ='Price descending';
  ...
  if (isset($_GET)) {
    ...
    #$sort_field =str_replace("date", "create_date", $sort_field);
      ...
      <left><br>
        ...
        <table border=0 class="table3">
          ...
          <tr>
            ...
            <td align="right"><input type="submit" name="submit" align="right" value=<? echo $lang_tanslate['Search']; ?>></td>
            
            <td align="right" data-label=<? echo $lang_tanslate['Sort:']; ?>><? echo $lang_tanslate['Sort:']; ?>
            <select  name="sort">
