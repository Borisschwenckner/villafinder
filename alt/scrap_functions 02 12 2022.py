...
#                            print(tag.get('d'))
        #    print(tag.get('d')[0:10])
            if tag.get('d')[0:10] == 'M43.87,12.':
                ...
                if searchtag == 'size':
                    return(size)
            elif tag.get('d')[0:9] == 'M51.6,35.': #M51.6,35.
...
def check_types():
        ...
        start2 = time.time()
        cur.execute("select id, name, property_type, ref from properties where (property_type is null or property_type ='') and create_date >= current_date-10 order by id desc ;")
       # cur.execute("select id, name, property_type, ref from properties where   state ='active' and site ='Primehomes' order by id desc ;")

        rows = cur.fetchall()
        for row in rows:
            id = row[0]
            ref = row[3]
            words_in_names=row[1].split(' ')
            property_type = row[2]
...
def get_types_old():
    ...
    Update properties  set property_type = 'Haus' where  property_type like'Casa%';
    Update properties  set property_type = 'Haus' where  property_type like'Bauernhaus%';
    Update properties  set property_type = 'Haus' where  property_type like'Landhaus%';
    Update properties  set property_type = 'Haus' where  property_type like'Doppelhaushälfte%';
    Update properties  set property_type = 'Haus' where  property_type like'Einfamilienhaus%';
    Update properties  set property_type = 'Haus' where  property_type like'Mehrfamilienhaus%';
    Update properties  set property_type = 'Haus' where  property_type like'Stadthaus%';
    Update properties  set property_type = 'Haus' where  property_type like'%Zweifamilienhaus%';
    Update properties  set property_type = 'Haus' where  property_type like'%Anwesen%';
    Update properties  set property_type = 'Haus' where  property_type like'%Strandhaus%';
    Update properties  set property_type = 'Haus' where  property_type like'%Townhouse%';
    Update properties  set property_type = 'Haus' where  property_type like'%Reihen%';
    Update properties  set property_type = 'Haus' where  property_type ='Chalet';
    Update properties  set property_type = 'Haus' where  lower(property_type) like 'Haus, Villa%';
    Update properties  set property_type = 'Haus' where  property_type like'Bungalow%';
    Update properties  set property_type = 'Haus' where  lower(property_type) like'% house%';
    Update properties  set property_type = 'Haus' where  property_type ='Freistehendes Haus';
    Update properties  set property_type = 'Haus' where  property_type ='besondere Immobilie';
    Update properties  set property_type = 'Haus' where  property_type ='Building';
#    Update properties  set property_type = 'Haus' where  property_type ='Terrasse';
    ...
    Update properties  set property_type = 'Villa' where lower(name) like '%vill%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Villa' where lower(name) like '%anwesen%' and  (property_type is null or property_type ='');
    Update properties  set property_type = 'Villa' where lower(name) like '%luxusoase%'  and (property_type is null or property_type ='');

    Update properties  set property_type = 'Penthouse' where lower(name) like '%penthouse%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Penthouse' where lower(name) like '%atico%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Penthouse' where (name) like '%Ático%'  and (property_type is null or property_type ='');


    Update properties  set property_type = 'Haus' where lower(name) like '%häuschen%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Haus' where lower(name) like '%bungalow%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Haus' where lower(name) like '%stadthaus%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Haus' where lower(name) like '%häuser%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Haus' where lower(name) like '%palast%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Haus' where lower(name) like '%house%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Haus' where lower(name) like '%reiheneckaus%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Haus' where lower(name) like '%reihenaus%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Haus' where lower(name) like '%haus%' and  (property_type is null or property_type ='');
    Update properties  set property_type = 'Haus' where lower(name) like '%chalet%'  and (property_type is null or property_type ='');

    

    Update properties  set property_type = 'Finca' where lower(name) like '%landsitz%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Finca' where lower(name) like '%landgut%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Finca' where lower(name) like '%agroturismus%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Finca' where lower(name) like '%finca%'  and (property_type is null or property_type ='');

    Update properties  set property_type = 'Wohnung' where lower(name) like '%wohnanlage%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Wohnung' where lower(name) like '%wohung%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Wohnung' where lower(name) like '%wohnung%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Wohnung' where lower(name) like '%apart%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Wohnung' where lower(name) like '%appartement%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Wohnung' where lower(name) like '%maisonette%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Wohnung' where lower(name) like '%loft%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Wohnung' where lower(name) like '%erdgeschoss%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Wohnung' where lower(name) like '%wohnung%' and (property_type is null or property_type ='');
    Update properties  set property_type = 'Wohnung' where lower(name) like '%sudio%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Wohnung' where lower(name) like '%duplex%'  and (property_type is null or property_type ='');

    Update properties  set property_type = 'Neubau' where lower(name) like '%projekt%' and (property_type is null or property_type ='');
    Update properties  set property_type = 'Neubau' where lower(name) like '%project%' and (property_type is null or property_type ='');
    Update properties  set property_type = 'Neubau' where lower(name) like '%neubau%'  and (property_type is null or property_type ='');

    Update properties  set property_type = 'Grundstück' where (name like '%grundstück%' or name like '%Grundstück%') and property_type != 'Grundstück' and (property_type is null or property_type ='');
    Update properties  set property_type = 'Grundstück' where (property_type like  '%Wohnen%') and name like '%Grundstück%'  and property_type != 'Grundstück';
    ...
    Update properties  set property_type = 'Grundstück' where  property_type like'Grundstück, Wohngrundstück%';
    Update properties  set property_type = 'Grundstück' where lower(name) like '%bauland%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Grundstück' where lower(name) like '%plot%'  and (property_type is null or property_type ='');


    Update properties  set property_type = 'Gewerbe' where lower(name) like '%  %'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Gewerbe' where lower(name) like '%geschäfts%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Gewerbe' where lower(name) like '%geschäfts%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Gewerbe' where lower(name) like '%ladenlokal%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Gewerbe' where lower(name) like '%gebäude%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Gewerbe' where lower(name) like '%büro%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Gewerbe' where lower(name) like '%lokal%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Gewerbe' where lower(name) like '%geschäft%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Gewerbe' where lower(name) like '%hotel%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Gewerbe' where lower(name) like '%gewerblich%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Gewerbe' where lower(name) like '%business%'  and (property_type is null or property_type ='');
    Update properties  set property_type = 'Gewerbe' where lower(name) like '%gewerbe%' and (property_type is null or property_type ='');
...
def database_service():
    ...
    try:
        ...
        --    delete from relations;
            ...
            WHERE
            properties.id!=pro1.id and
            properties.price > 0 and
            pro1.price > 0 and
            properties.price=pro1.price AND properties.location_id=pro1.location_id AND
            properties.bedroom=pro1.bedroom and properties.bathroom=pro1.bathroom AND properties.state = 'active' AND pro1.state = 'active' and pro1.offer_type ='Buy' and properties.offer_type ='Buy'
...
def set_inactive():
    ...
    #Bedroom
    cur.execute("UPDATE properties  SET bedroom = sitemap.bedroom FROM sitemap WHERE sitemap.url = properties.url AND properties.bedroom != sitemap.bedroom and sitemap.bedroom > 0;")
    cur.execute("commit;")

    #Size
    cur.execute("UPDATE properties  SET living_size = sitemap.size  FROM sitemap  WHERE sitemap.url = properties.url  AND properties.living_size != sitemap.size  AND sitemap.price IS NOT NULL and sitemap.size > 0;")
    cur.execute("commit;")

    #GroundSize
    cur.execute("UPDATE properties  SET ground_size=sitemap.groundsize FROM sitemap WHERE sitemap.url=properties.url AND properties.ground_size !=sitemap.groundsize AND sitemap.price IS NOT NULL AND sitemap.groundsize> 0;")
    cur.execute("commit;")
    #images
    cur.execute("UPDATE sitemap set image ='' where image like '%base64,%' ")
    cur.execute("commit;")
    cur.execute("UPDATE properties SET image_url=sitemap.image,image_download_state=0 FROM sitemap WHERE sitemap.url=properties.url AND (properties.image_url is null or properties.image_url = '') AND properties.STATE='active' ")
    cur.execute("commit;")
    cur.execute("UPDATE properties SET image_url=sitemap.image,image_download_state=0 FROM sitemap WHERE sitemap.url=properties.url AND image<> properties.image_url AND (sitemap.image IS NOT NULL OR sitemap.image !='') AND properties.STATE='active' AND image_download_state !=1;")
    cur.execute("commit;")
    ...
    #REF
    cur.execute("UPDATE properties SET ref=sitemap.ref FROM sitemap WHERE sitemap.url=properties.url AND properties.ref !=sitemap.ref AND (sitemap.ref IS NOT NULL and sitemap.ref !='')")
    cur.execute("commit;")
...
def set_locations_old():
    cur, conn = connect_properties()

    sql = """
    --update properties set location_id = null where location_id is not null;
    ...
    UPDATE properties set location = trim(split_part(location,'/', 2)) where site ='Kensington' and "location" like '%/%';
    UPDATE properties set location = trim(split_part(location,'-', 1)) where site ='Casanova' and "location" like '%-%';
    UPDATE properties set location = trim(split_part(location,'-', 2)) where site ='DC-Mallorca' and "location" like '%-%';
    UPDATE properties set location = trim(split_part(location,'-', 1)) where site ='Immobilienmallorca'  and "location" like '%/%';
    UPDATE properties set location = trim(split_part(location,'-', 1)) where site ='Mallorcagold'   and "location" like '%-%';
    UPDATE properties set location = trim(split_part(location,'/', 2)) where site ='Primehomes'   and "location" like '%/%';
    UPDATE properties set location = trim(split_part(location,'/', 2)) where site ='Sandberg'    and "location" like '%/%';
    UPDATE properties set location = trim(split_part(location,'/', 2)) where site ='Toni Da Silva'    and "location" like '%/%';
    UPDATE properties set location = trim(split_part(location,',', 4)) where site ='Engel & Völkers'    and "location" like '%,%';

    UPDATE properties SET LOCATION=locations.city,location_id=locations.ID,location_search=locations.city FROM locations WHERE properties.NAME LIKE '%' || locations.city || '%' AND (LOCATION IS NULL OR LOCATION='');
    UPDATE properties SET LOCATION=locations.city,location_id=locations.ID,location_search=locations.city FROM locations WHERE locations.searchterms LIKE '%' || TRIM (split_part(NAME,'in',2)) || '%' AND LENGTH (TRIM (split_part(NAME,'in',2)))> 4 AND (LOCATION IS NULL OR LOCATION='');

    update properties pt set location_id =
    (select id from locations where pt.location = locations.city)
    where  ( LOCATION_id =0 OR LOCATION_id is null)
    and (select id from locations where pt.location = locations.city) is not null;

    update properties pt set location_id =
    (select id from locations where lower(pt.location) = lower(locations.city))
    where  ( LOCATION_id =0 OR LOCATION_id is null)
    and (select id from locations where lower(pt.location) = lower(locations.city)) is not null;

        --engels
        select id, location_id ,
        (select id from locations where lower(pt.city) = lower(locations.city))
       	from properties pt
    	where   ( LOCATION_id =0 OR LOCATION_id is null)
        and (select id from locations where lower(pt.city) = lower(locations.city)) is not null;
        --engel
        update properties pt set location_id =
        (select id from locations where  locations.searchterms ~ pt.city and searchterms is not null limit 1)
        where
        (location_id is null or location_id =0)
        and (select id from locations where  locations.searchterms ~ pt.city and searchterms is not null limit 1) is not null;

    update properties pt set location_id =
    (select id from locations where  locations.searchterms ~ pt.location and searchterms is not null limit 1)
    where
    (location_id is null or location_id =0)
    and (select id from locations where  locations.searchterms ~ pt.location and searchterms is not null limit 1) is not null
    ;

    update properties pt set location_id =
     (select id from locations where  locations.searchterms ~ trim(split_part(pt.location , ',',1)) and searchterms is not null limit 1)
    where
    (location_id is null or location_id =0)
    and (select id from locations where  locations.searchterms ~ trim(split_part(pt.location , ',',1)) and searchterms is not null limit 1) is not null and trim(split_part(pt.location , ',',1)) != 'Mallorca'
    ;
    ...
    cur.execute("""select id, location from properties where location_id is null
    and state = 'active'
    ...
    for row in rows:
        ...
        location = strip_accents(row[1])
        if "s'" in location:
            location = location.split("s'")[1].strip()
        if "'" in location:
            location = location.replace("'","").strip()
        if '/' in location:
            location = location.split('/')[1].strip()
        if '-' in location:
            location1 = location.split('-')[1].strip()
            location2 = location.split('-')[0].strip()
            location = location1
        if ',' in location:
            location1 = location.split(',')[1].strip()
            location2 = location.split(',')[0].strip()
        ...
        lower_location = location.lower().strip()
        lower_location2 = location2.lower().strip()
        location_id = 0


        if 'nord' in location2.lower() or 'mallorca' in location2.lower() or 'süd' in location2.lower() or 'ost' in location2.lower() or 'west' in location2.lower() or 'zentrum' in location2.lower():
            location2 = ''
        if 'nord' in location2.lower() or 'mallorca' in location2.lower() or 'süd' in location2.lower() or 'ost' in location2.lower() or 'west' in location.lower() or 'zentrum' in location.lower():
            location = ''
        print ('Location ', location)
        #print ('Location2 ', location2)
        #print ('Location lower ', lower_location)
        #print ('Location2 lower', lower_location2)

        if location_id == 0:
            cur.execute("select id from locations WHERE (city) LIKE '%" + location + "%'")
            try:
        ...
        if location_id == 0:
            cur.execute("select id from locations WHERE lower(city) LIKE '%" + lower_location + "%'")
            try:
                location_id = cur.fetchone()[0]
            except:
                location_id = 0
        ...
        if location_id ==0:
            cur.execute("select id from locations WHERE (searchterms) LIKE '%" + location + "%'")
            try:
                location_id = cur.fetchone()[0]
            except:
                location_id = 0
        ...
        if location_id ==0:
            cur.execute("select id from locations WHERE lower(searchterms) LIKE '%" + lower_location + "%'")
            try:
                location_id = cur.fetchone()[0]
            except:
                location_id = 0

        if location_id ==0 and location2 !='':
            cur.execute("select id from locations WHERE lower(city) LIKE '%" + lower_location2 + "%'")
            try:
                location_id = cur.fetchone()[0]
            except:
                location_id = 0
        ...
        if location_id > 0:
            print ('update:', location, id, location_id)
            cur.execute("update properties set location_id = %s where id = %s;", ( [ location_id, id ]))
            cur.execute("commit;")

    cur.execute("UPDATE properties SET location_search=locations.area|| ' , ' || regions.NAME || ' , ' || locations.city FROM locations,regions WHERE location_id=locations.ID AND region_id=regions.ID AND (location_search !=locations.area|| ' , ' || regions.NAME || ' , ' || locations.city OR location_search IS NULL)")
    cur.execute("commit;")
...
def set_locations():
    ...
    UPDATE properties set location = trim(split_part(location,'/', 2)) where site ='Toni Da Silva'    and "location" like '%/%';
    UPDATE properties set location = trim(split_part(location,',', 4)) where site ='Engel & Völkers'    and "location" like '%,%';
    UPDATE properties set location = trim(split_part(location,'-', 2)) where site ='Minkner' and "location" like '%-%';
    delete from locations_temp where name ='';
    UPDATE properties SET location=split_part(LOWER (NAME),' in ',4) WHERE site='Neptunus' AND split_part(LOWER (NAME),' in ',4) !='' AND location=''  AND (location_id IS NULL OR location_id=0);
    UPDATE properties SET location=split_part(LOWER (NAME),' in ',3) WHERE site='Neptunus' AND split_part(LOWER (NAME),' in ',3) !='' AND location='' AND (location_id IS NULL OR location_id=0);
    UPDATE properties SET location=split_part(LOWER (NAME),' in ',2) WHERE site='Neptunus' AND split_part(LOWER (NAME),' in ',2) !='' AND location='' AND (location_id IS NULL OR location_id=0);
    UPDATE properties SET location=split_part(LOWER (NAME),' von ',2) WHERE site='Neptunus' AND split_part(LOWER (NAME),' von ',2) !='' AND location='' AND (location_id IS NULL OR location_id=0);
...
#        regions_list.append(region[0])
    ...
    for row in rows:
        ...
        if location_id > 0:
            print(location_id, search_location,  location_id_org, id)
            cur.execute("update properties set location_id = %s where id = %s;", ( [ location_id, id ]))
            cur.execute("commit;")
    #cur.execute("UPDATE properties SET location_search=locations.area|| ' , ' || regions.NAME || ' , ' || locations.city FROM locations,regions WHERE location_id=locations.ID AND region_id=regions.ID AND (location_search !=locations.area|| ' , ' || regions.NAME || ' , ' || locations.city OR location_search IS NULL)")
    #cur.execute("commit;")
#
    #cur.execute("UPDATE properties SET location_search=locations.area|| ' , ' || locations.city FROM locations,regions WHERE location_id=locations.ID AND region_id=regions.ID AND (location_search !=locations.area|| ' , ' || locations.city OR location_search IS NULL)")
    #cur.execute("commit;")
#
...
def get_missing_images():
    ...
    urls=[]
    something_found =0
    cur.execute("select properties.id, url, properties.site from properties , sites where image_download_state !=1 and properties.state = 'active' and sites.site = properties.site and create_property_from_sitemap = 2")
    rows = cur.fetchall()
    for row in rows:
        urls.append(row[1])
        site=row[2]
